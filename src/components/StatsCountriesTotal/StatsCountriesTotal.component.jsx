...
import { Grid, Card, Alert, Dimmer, Table } from 'tabler-react';
    ...
    return (
        <React.Fragment>
            ...
            <Grid.Col sm={12}>
                <Card>
                    <Card.Header>
                        <h3 className='card-title'>Statistiken nach Land</h3>
                    </Card.Header>
                    <Table
                        responsive
                        striped
                    ...
                    >
                        <Table.Header>
                            <Table.Row>
                                <th>Land</th>
                                <th className='text-right'>Bestätigte Fälle</th>
                                <th className='text-right'>
                                    Fälle <small>(Heute)</small>
                                </th>
                                <th className='text-right'>Todesfälle</th>
                                <th className='text-right'>
